...
| Роль | Клиенты | Провайдеры | Компании ОФД | Календарь | Пользователи | Настройки |
|------|---------|-----------|-------------|----------|-------------|----------|
...
│   │       ├── views.py          # API, SSH, Excel, провайдер, календарь, ККТ
│   │       ├── serializers.py
...
│   │   │   ├── ClientFormPage.jsx    # Вкладка ККТ: поля РНМ, кнопки ИНН/РНМ, редактирование
│   │   │   ├── OfdCompaniesPage.jsx  # Страница управления компаниями ОФД
│   │   │   ├── CalendarPage.jsx
│   │   │   ├── SettingsPage.jsx
│   │   │   ├── UsersPage.jsx
│   │   │   └── ProvidersPage.jsx
│   │   ├── components/
│   │   │   └── AppLayout.jsx         # Меню + пункт «Компании»
│   │   ├── store/
│   │   │   ├── authStore.js
│   │   │   └── themeStore.js
│   │   └── api/index.js
